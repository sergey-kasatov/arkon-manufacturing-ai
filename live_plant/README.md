...
`/data/arkon/incident_notifications.jsonl` for the Quality Manager cards once
`n8n/overdue_escalation_v1.json` is deployed. Unifying them is the intake workflow
