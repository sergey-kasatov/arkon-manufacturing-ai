...
the manager notification for a lapsed window (built as
`n8n/overdue_escalation_v1.json`, not yet deployed), the daily digest, and one
unified log of every notification sent. The assistant can report every state and
